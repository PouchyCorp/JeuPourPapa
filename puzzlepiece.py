import pygame as pg
from globalSurfaces import PUZZLE_PIECE

class PuzzlePiece:
    def __init__(self, x, y, color, rotation=0):
        self.image : pg.Surface = PUZZLE_PIECE.copy()
        self.image.fill(color+[255], special_flags=pg.BLEND_RGBA_MIN) # tint the black puzzle piece with the given color (keeping alpha)
